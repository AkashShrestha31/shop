...
import 'package:shoppos/features/OTP_verification/presentation/widgets/otp_field_style.dart';
...
class _OTPTextFieldState extends State<OTPTextField> {
  ...
  Widget buildTextField(BuildContext context, int index) {
    ...
    return Container(
      decoration: BoxDecoration(color: Color(0xFFF3F4F8), borderRadius: BorderRadius.circular(SizeConfig.safeBlockHorizontal! * 2.5)),
