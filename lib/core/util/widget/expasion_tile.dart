      ...
      child: Column(
        ...
        children: <Widget>[
          ListTileTheme.merge(
            ...
            textColor: _isExpanded ? infoColor : Colors.black,
            tileColor: _isExpanded ? Color.fromRGBO(51, 96, 187, 0.2) : Colors.transparent,
            child: ListTile(
              onTap: _handleTap,
              ...
              leading: Padding(
                ...
                child: SvgPicture.asset(widget.leading!,
                    color: _isExpanded ? Theme.of(context).primaryColor : Colors.grey[500], semanticsLabel: 'App Logo', fit: BoxFit.scaleDown),
              ),
              title: widget.title,
