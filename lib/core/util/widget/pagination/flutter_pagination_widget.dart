...
class WebPagination extends StatefulWidget {
  ...
  const WebPagination({Key? key, required this.onPageChanged, required this.currentPage, required this.totalPage}) : super(key: key);
    ...
    return Container(
        ...
        child: TextField(
          ...
          style: const TextStyle(
              textBaseline: TextBaseline.alphabetic, color: Color(0xFF0175C2), fontSize: 15, height: 1.5, fontWeight: FontWeight.w600),
...
class _ItemContainer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: child,
      padding: EdgeInsets.fromLTRB(SizeConfig.safeBlockHorizontal! * 4, 0, SizeConfig.safeBlockHorizontal! * 3, 0),
      constraints: BoxConstraints(minWidth: SizeConfig.safeBlockHorizontal! * 4, minHeight: SizeConfig.safeBlockHorizontal! * 4),
